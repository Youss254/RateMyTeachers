      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          ...
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Teachers </a>
          </div>
        </div>
          <div>
                  ...
                  <table class="table">
                    ...
                    <c:forEach var="dato" items="${teachers}">
                     <tr>
                        ...
                        <td>${dato.ecole}</td>
                        <td align="right">
                         <a href="edit_teacher.htm?id=${dato.id}" class="btn btn-primary btn-round">Update</a>
                         &ensp;
                         <a href="delete_teacher.htm?id=${dato.id}" class="btn btn-primary btn-round">Delete</a>
                        </td>
                     </tr>
                     </c:forEach>   
                    </tbody>
