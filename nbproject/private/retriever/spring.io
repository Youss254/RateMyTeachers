...
<h2>Spring Framework 5<br />The right stack for the right job.</h2>
...
<br />
<p>
<a href="https://docs.spring.io/spring-boot/docs/current/reference/html/"><i class="icon-file-text"></i> Spring Boot Reference Manual</a>
</p>
<p>
