...
<a href="" data-type="professor-names" class="active">Name</a>
<a href="find_professor_by_school.htm" data-type="professor-locations" class="">School</a>
</div>
...
<input type="text" name="prenom" id="searchProfessorName" data-type="name" placeholder="teacher's name" autocorrect="off" autocomplete="off" required="" class="ui-autocomplete-input">
...
<form action="" method="get" name="prof-location" class="professor-locations" id="prof-location">
<div class="search-info">
