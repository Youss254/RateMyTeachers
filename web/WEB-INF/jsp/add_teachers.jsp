              ...
              <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Subject</label>
                        <input type="text" class="form-control" placeholder="" name="matiere" value="">
                      </div>
                    </div>
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Experience</label>
                        <input type="text" class="form-control" placeholder="" name="experience" value="">
                      </div>
                    </div>
                  </div>
                      <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>School</label>
                        <input type="text" class="form-control" placeholder="" name="ecole" value="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="update ml-auto mr-auto">
                      ...
                      <button class="btn btn-primary btn-round">Add Profile</button>
